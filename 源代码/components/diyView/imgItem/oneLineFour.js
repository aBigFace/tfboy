      ...
      return {
        ...
        itemStyle: function(e) {
          return {
            position: "relative",
            marginBottom: o(e),
            width: "calc((100%/4) - ".concat(2 * n.value.mrConfig / 4 + 1, "px)"),
            marginRight: e % 4 == 3 ? "" : "".concat(n.value.mrConfig, "px")
          }
        }
      }
    }
...
var n = e._export_sfc(i, [
  ...
  ["__scopeId", "data-v-2ae7c091"],
  ["__file", "E:/project/TF/tf-wechat/src/components/diyView/imgItem/oneLineFour.vue"]
]);
