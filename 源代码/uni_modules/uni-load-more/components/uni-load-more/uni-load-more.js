var e, n = require("../../../../common/vendor.js"),
  o = require("./i18n/index.js");
setTimeout((function() {
  e = n.index.getSystemInfoSync().platform
}), 16);
var t = n.initVueI18n(o.messages).t,
  i = {
    name: "UniLoadMore",
    emits: ["clickLoadMore"],
    props: {
...
var c = n._export_sfc(i, [
  ["render", function(e, o, t, i, c, A) {
    return n.e({
  ...
  ["__file", "E:/project/TF/tf-wechat/src/uni_modules/uni-load-more/components/uni-load-more/uni-load-more.vue"]
]);
